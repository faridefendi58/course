<?php
	...
	$status_wise_invoices = $this->crud_model->get_status_wise_invoices();
 ?>
<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <li class = "<?php echo is_multi_level_active(['invoices', 'unpaid', 'paid'], 1); ?>">
            <a href="javascript:;">
                <i class="fa fa-money"></i>
                <span><?php echo get_phrase('invoices'); ?></span>
            </a>
            <ul class="sub-menu">
                <li class = "<?php echo is_active('unpaid'); ?>" >
                    <a href="<?php echo site_url('admin/invoices/view/0'); ?>">
                        <?php echo get_phrase('unpaid_invoices'); ?>
                        <span class = "badge badge-secondary" data-toggle="tooltip" data-placement="top" title="<?php echo get_phrase('number_of_unpaid_invoice').': '.$status_wise_invoices['unpaid']->num_rows(); ?>"><?php echo $status_wise_invoices['unpaid']->num_rows(); ?></span>
                    </a>
                </li>
                <li class = "<?php echo is_active('paid'); ?>" >
                    <a href="<?php echo site_url('admin/invoices/view/1'); ?>">
                        <?php echo get_phrase('paid_invoice'); ?>
                        <span class = "badge badge-secondary" data-toggle="tooltip" data-placement="top" title="<?php echo get_phrase('number_of_paid_invoice').': '.$status_wise_invoices['paid']->num_rows(); ?>"><?php echo $status_wise_invoices['paid']->num_rows(); ?></span>
                    </a>
                </li>
                <br>
            </ul>
