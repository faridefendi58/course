...
<ol class="breadcrumb bc-3">
    ...
    <li><a href="<?php echo site_url('admin/users'); ?>"><?php echo get_phrase('users'); ?></a> </li>
    <li><a href="#" class="active"><?php echo get_phrase('edit_users'); ?></a> </li>
</ol>
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                <form class="" action="<?php echo site_url('admin/manage_users/edit/'.$user_id); ?>" method="post" enctype="multipart/form-data">
                    <div class="col-md-8">
