                ...
                <div class="modal-content payment-in-modal">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form action="<?php echo site_url('home/transfer_bank_checkout'); ?>" method="post">
                                    <input type="hidden" class = "total_price_of_checking_out" name="total_price_of_checking_out" value="">
                                    <button type="submit" class="btn btn-success btn-block" <?php echo $paypal_status; ?>><?php echo get_phrase('transfer_bank'); ?></button>
                                </form>
                            </div>
                            <div class="col-md-6">
